...
export class ApiService {
    private reviews = [new Review(1, 'Golden State', 'Ben Winters', 'Matt Buscemi', 'Friday 15th February 2019',
    'https://img2.sfbook.com/books/small/golden-state.jpg',
    ...
    new Review(2, 'Star Trek Prometheus: In the Heart of Chaos', 'Bernd Perplies', 'Sam Tyler', 'Thursday 14th February 2019',
    'https://img2.sfbook.com/books/small/star-trek-prometheus:-in-the-heart-of-chaos.jpg', 
    ...
    new Review(3, 'City of the Iron Fish', 'Simon Ings', 'Matt Buscemi', 'Monday 11th February 2019',
    'https://img2.sfbook.com/books/small/city-of-the-iron-fish.jpg', 
    'By the end of the eighteenth century, our world had become fully charted, catalogued, mapped and explored. No longer could it be imagined that beyond some distant horizon there lay a land of extraordinary wonders—a hidden utopia, for example, nestled away somewhere safe from the corrupting influence of our imperfect, real-world societies. Or perhaps a fountain whose waters granted perpetual youth. Science fiction, of course, finds ways around this, the most obvious tropes being ...')];
